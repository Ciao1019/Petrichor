...
export function AgentKeysPage() {
  ...
  return (
    <div className="mx-auto flex w-full max-w-4xl flex-col gap-8 p-4 md:py-8 md:px-6">
      <AgentPageHeader
        icon={KeyRound}
        title="API 密钥"
        ...
        actions={
          <>
            <Button type="button" variant="ghost" size="sm" onClick={() => void fetchKeys()} disabled={loading}>
      ...
      <div className="space-y-3 pt-2">
        <div className="space-y-0.5">
          ...
          <p className="text-xs text-muted-foreground">
            调用时以 <span className="font-mono">Authorization: Bearer &lt;API Key&gt;</span> 请求头鉴权；撤销立即生效。
          </p>
        </div>
