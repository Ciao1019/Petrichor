...
func registerKBRoutes(rg *gin.RouterGroup) {
	...
	kbGroup.POST("/wiki/export", func(c *gin.Context) { kb.WikiExport(c) })
	kbGroup.POST("/wiki/guide", func(c *gin.Context) { kb.WikiGuideDetail(c) })
	kbGroup.POST("/wiki/guide/save", func(c *gin.Context) { kb.WikiGuideSave(c) })
	kbGroup.POST("/wiki/skill-pack", func(c *gin.Context) { kb.WikiSkillPack(c) })
